...
{
    partial class FormSucursalNuevo
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Controls.Add(this.chkVentaSucursal);
            this.Controls.Add(this.label9);
            this.Controls.Add(this.label3);
            this.Controls.Add(this.panelLevel3);
            this.Controls.Add(this.chkCajaSucursal);
            this.Controls.Add(this.bunifuSeparator1);
            this.Controls.Add(this.label5);
            this.Controls.Add(this.label4);
            this.Controls.Add(this.chkAdministracionSucursal);
            this.Controls.Add(this.panelLevel2);
            this.Controls.Add(this.label7);
            this.Controls.Add(this.chkGerenciaSucursal);
            this.Controls.Add(this.textDirecionSucursal);
            this.Controls.Add(this.panelLevel1);
            this.Controls.Add(this.panelFooter);
            this.Controls.Add(this.textNombreSucursal);
            ...
            this.Shown += new System.EventHandler(this.FormSucursalNuevo_Shown);
            this.Paint += new System.Windows.Forms.PaintEventHandler(this.FormSucursalNuevo_Paint);
