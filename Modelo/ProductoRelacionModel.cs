    ...
    public class ProductoRelacionModel
    {
        ...
        public async Task<Response> guardar(ProductoRelacion param)
        {
            try
            {
                ...
                return await webService.POSTSend("prelacion", "guardar", param);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public async Task<Response> modificar(ProductoRelacion param)
        {
            try
            {
                ...
                return await webService.POSTSend("prelacion", "modificar", param);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public async Task<Response> eliminar(ProductoRelacion param)
        {
            try
            {
                ...
                return await webService.POSTSend("prelacion", "eliminar", param);
            }
            catch (Exception ex)
            {
                throw ex;
